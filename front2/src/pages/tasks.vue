  ...
  <div class="relative min-h-full flex flex-col">
        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex items-center px-2 lg:px-0 xl:w-64 text-white">
            <div class="flex-shrink-0">
              <button @click="this.$router.push('/projects')" type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-20 ml-0"> Back to Projects</button>
            </div>
          </div>
          <div class="flex items-center px-2 lg:px-0 xl:w-64 text-white">
            <div class="flex-shrink-0">
    ...
    <div class="flex-grow w-full max-w-7xl mx-auto xl:px-8 lg:flex">
      ...
      <div class="flex-1 min-w-0 bg-white xl:flex">
              ...
              <div class="flex-1 space-y-8">
                <div class="space-y-8 sm:space-y-0 sm:flex sm:justify-between sm:items-center xl:block xl:space-y-8">
                  ...
                  <div class="flex flex-col sm:flex-row xl:flex-col">
                    ...
                    <button @click="createTask()" type="button" class="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 xl:w-full">New Task</button>
        ...
        <div class="bg-white lg:min-w-0 lg:flex-1">
          ...
          <ul  v-for="task in sortObjectByKeys(tasks)"  :key="task._id"  role="list" class="relative z-0 divide-y divide-gray-200 border-b border-gray-200">
            <li v-if="task.status=='Not Done'" class=" cursor-pointer relative pl-4 pr-6 py-5 hover:bg-gray-50 sm:py-6 sm:pl-6 lg:pl-8 xl:pl-6" @click="setDone(task._id)">
      ...
      {{ task.name }} </label> 
          ...
          <ul v-for="task in sortObjectByKeys(tasks)" :key="task._id" role="list" class="relative z-0 divide-y divide-gray-200 border-b border-gray-200">
            <li    v-if="task.status=='Done'" class=" cursor-pointer relative pl-4 pr-6 py-5 hover:bg-gray-50 sm:py-6 sm:pl-6 lg:pl-8 xl:pl-6" @click="setDone(task._id)">
              <div   class="flex items-center justify-between space-x-4">
                <div class="min-w-0 space-y-3">
                  <div class="flex items-center space-x-3">
...
methods: {
     setDone(id) {
      ...
      this.$store.commit('setTaskStatus',{ id,status:nestStatus})
     },
     sortObjectByKeys(o) {
      if(o)
